...
// ------------------------------------
class W68ShaderZoomBlur(ctx: Context): ES32MgShader(ctx) {
    // 頂点シェーダ
    private val scv =
            """#version 300 es
    ...
    override fun loadShader(): ES32MgShader {
        ...
        // uniform(マウス位置)
        hUNI[4] = GLES32.glGetUniformLocation(programHandle, "u_center")
        MyGLES32Func.checkGlError("u_center:glGetUniformLocation")
    ...
    fun draw(vao: ES32VAOAbs,
        ...
        // uniform(マウス位置)
        GLES32.glUniform2fv(hUNI[4],1, u_center,0)
        MyGLES32Func.checkGlError("u_center",this,model)
