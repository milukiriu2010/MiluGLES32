...
// ------------------------------------
class W68ShaderScreen(ctx: Context): ES32MgShader(ctx) {
    // 頂点シェーダ
    private val scv =
            """#version 300 es
    ...
    override fun loadShader(): ES32MgShader {
        ...
        // uniform()
        hUNI[5] = GLES32.glGetUniformLocation(programHandle, "u_mask")
        MyGLES32Func.checkGlError("u_mask:glGetUniformLocation")
    ...
    fun draw(vao: ES32VAOAbs,
        ...
        // uniform()
        GLES32.glUniform1i(hUNI[5], u_mask)
        MyGLES32Func.checkGlError("u_mask",this,model)
