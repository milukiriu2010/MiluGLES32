...
// -------------------------------------------
class W54Renderer(ctx: Context): MgRenderer(ctx) {
    ...
    // シェーダ(セピア調変換)
    private val shaderSepia = W54ShaderSepia(ctx)
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        shaderSepia.draw(vaoBoard,matVP, 0,u_grayScale,u_sepiaScale)
    }
