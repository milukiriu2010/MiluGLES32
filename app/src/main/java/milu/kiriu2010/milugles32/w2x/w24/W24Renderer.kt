package milu.kiriu2010.milugles32.w2x.w24
...
import milu.kiriu2010.gui.shader.es32.ES32PhongShading01Shader
...
// ---------------------------------------------------
class W24Renderer(ctx: Context): MgRenderer(ctx) {
    ...
    // シェーダ(フォンシェーディング)
    private val shader = ES32PhongShading01Shader(ctx)
