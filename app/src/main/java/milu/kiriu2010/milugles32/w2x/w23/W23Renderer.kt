package milu.kiriu2010.milugles32.w2x.w23
...
import milu.kiriu2010.gui.shader.es32.ES32SpecularLight01Shader
...
// ---------------------------------------------------
class W23Renderer(ctx: Context): MgRenderer(ctx) {
    ...
    // シェーダ(反射光)
    private val shader = ES32SpecularLight01Shader(ctx)
    ...
    override fun onDrawFrame(gl: GL10) {
        ...
        // モデル描画
        shader.draw(vao,matMVP,matI,vecLight,vecEye,vecAmbientColor)
    }
