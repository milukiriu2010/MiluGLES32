package milu.kiriu2010.milugles32.w3x.w34
...
class W34Fragment : androidx.fragment.app.Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_w34, container, false)

        myGLES32View = view.findViewById(R.id.myGLES32ViewW34)
        val renderer = W34Renderer(context!!)
