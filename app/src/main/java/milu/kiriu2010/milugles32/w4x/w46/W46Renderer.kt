...
// -------------------------------------------------------
class W46Renderer(ctx: Context): MgRenderer(ctx) {
    // 描画オブジェクト(立方体)
    ...
    // シェーダ
    private val shader = W46Shader(ctx)
    ...
    override fun onDrawFrame(gl: GL10?) {
        ...
        shader.draw(vaoCube,matM,matMVP,vecEye,0,0,refractRatio)
        ...
        Matrix.multiplyMM(matMVP,0,matVP,0,matM,0)
        shader.draw(vaoSphere,matM,matMVP,vecEye,-1,1,refractRatio)
        ...
        Matrix.multiplyMM(matMVP,0,matVP,0,matM,0)
        shader.draw(vaoTorus,matM,matMVP,vecEye,-1,1,refractRatio)
    }
